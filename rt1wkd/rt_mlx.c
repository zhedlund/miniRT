...
int main()
{
	...
	cam.viewport_width = 2.0 * tan(fov_radians / 2.0); // viewport height based on FOV
    cam.viewport_height = cam.viewport_width * ((double)image_height / image_width);
