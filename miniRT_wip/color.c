...
/* 	Calculate the color of a pixel mixed with a transparent color.
	Returns a new color value that is the mix of two input color values.
*/
t_color alpha_color(t_color c1, t_color c2, float alpha)
{
	return ((t_color){c1.r * (1 - alpha) + c2.r * alpha,
