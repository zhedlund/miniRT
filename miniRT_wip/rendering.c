...
/*   Updated: 2024/05/01 18:45:54 by kdzhoha          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    t_vec shadow_dir = vec3_subtract(scene->l.pos, *intersect);
    t_ray shadow_ray = {*intersect, vec3_unit_vector(&shadow_dir)};
    const t_obj *obj = scene->objs;
    float shadow_t = 1.0;
    while (obj != NULL)
    {
